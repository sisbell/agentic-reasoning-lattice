...
| RA-adm | discharged in three layers: shape package (from RA-dom), subspace preservation (RE-subpres), and the remaining per-state invariants (via ExtendedReachableStateInvariants) |
