...
*Standing premise of the REARRANGE_K realisation.* Σ is reachable from Σ₀ by a finite sequence of elementary transitions drawn from valid composites. Under this premise we extend reachability across the REARRANGE_K step rather than assume it of Σ'.
