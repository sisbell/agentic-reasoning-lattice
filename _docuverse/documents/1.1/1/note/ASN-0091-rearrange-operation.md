...
| RA-adm | the K.μ~-validity / empty-composite argument below makes Σ' reachable; the per-state foundation invariants then follow at Σ', discharged in the RA-adm paragraph below |
