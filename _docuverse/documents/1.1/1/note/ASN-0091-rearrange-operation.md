...
REARRANGE_K (the cut-sequence operation of ASN-0084) is one concrete realisation of the abstract Vstream-only class. Per the case split established above, the clause-by-clause argument below treats the non-trivial case (realiser K.μ~); the collapse case needs no clause discharge.
