...
This lifts the per-address T4-validity of L1c's chain terminus to a universal invariant over `dom(Σ.L)`. The well-definedness of the T4b projections — and hence of `home` and `subspace_I` — that it underwrites was already noted in L1c's proof.
