...
| NestingByDelegation | `(A Σ reachable, π₁ ≠ π₂ ∈ Π_Σ : pfx(π₁), pfx(π₂) non-nesting ∨ delegated_Σ*(π₁, π₂) ∨ delegated_Σ*(π₂, π₁))` — distinct principals are either non-nesting or related by a chain of delegation events | from O1b, O12, O13, O14(vi), delegation condition (vi), covering-chain lemma |
