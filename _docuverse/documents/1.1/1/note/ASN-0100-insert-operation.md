...
**Scope of ASN-0082's I3 against INSERT's post-state.** This ASN cites I3's positive shift clause and the companion lemmas I3-L, I3-X, I3-D, I3-VD, I3-VP, I3-fin, I3-S2, I3-S3, which govern the regions ASN-0082's shift-only model covers; it does not cite I3-V, I3-CS, I3-CX, I3-C, or I3-S7, which characterise that shift-only post-state and do not hold of INSERT's `M'(d)`, since INSERT adds an Insertion region and allocates fresh content that the shift-only model omits.
