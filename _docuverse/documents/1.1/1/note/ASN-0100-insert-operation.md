...
**Scope of ASN-0082's I3 against INSERT's post-state.** This ASN cites I3 for its positive shift clause. I3's whole-post-state characterizations — in particular I3-C (`Σ'.C = Σ.C`) — do not hold of INSERT's `M'(d)`, because INSERT additionally adds an Insertion region and allocates fresh content that the shift-only model omits.
