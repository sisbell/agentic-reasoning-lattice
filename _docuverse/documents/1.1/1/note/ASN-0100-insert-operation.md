...
- `E' = E`. The entity set is unchanged: no K.δ fires in the decomposition, hence `E'_doc = E_doc`; INSERT registers no new document and creates no new node, account, or non-document entity.
