...
| SubAllocatorAxiom | ContentLinkSubAllocatorChainDiscipline | AXIOM | Single clause (ChainDiscipline): the content/link sub-allocator chains are the ASN-0040 sibling streams `S(b_·(d), 1)`. |
