...
| SubAllocatorAxiom | ContentLinkSubAllocatorExistence | AXIOM | Three clauses: Exists, FirstEmission (structural form — `[d.0.s_C.1]` resp. `[d.0.s_L.1]`, both T4-valid by inspection), ChainDiscipline (sub-allocator chains are the ASN-0040 sibling streams `S(b_·(d), 1)`). |
