...
| X14 | ContainmentRecording and coupling discharge — `d` recorded as containing each copied address; provenance written to `Σ.R`; J0/J1★/J1'★ discharged, P7/P4★/P4a/P7a preserved, link/entity Class (a) invariants vacuous; record permanent; against destination | introduced |
