...
A COPY whose source or target is mutated earlier in the same composite is outside this note's scope; in the integrated model such an edit must be expressed as a separate standalone COPY against the already-committed boundary state.
