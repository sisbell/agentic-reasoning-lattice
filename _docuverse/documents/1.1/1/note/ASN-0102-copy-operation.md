...
COPY touches only the arrangement; it allocates no fresh I-address and adds nothing to `dom(Σ.C)` — placing existing content and creating new content are different acts over the same address machinery.
