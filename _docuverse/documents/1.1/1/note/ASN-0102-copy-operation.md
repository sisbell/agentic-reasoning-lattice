...
- **(P2) Target document.** `d ∈ E_doc`, equivalently `d ∈ dom(Σ.M)` (`dom(Σ.M) = E_doc`, ASN-0047). In particular the pair `(a_j + i, d)` that COPY's effect writes into `Σ.R` is well-typed precisely because `d ∈ E_doc`.
