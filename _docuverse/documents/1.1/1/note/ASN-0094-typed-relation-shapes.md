...
**Lemma — CoverageEqualityDecidability.** For any two finite endsets `E, E' ∈ Endset`, the predicate `coverage(E) = coverage(E')` is decidable, using only T1, T2, T12, TumblerAdd, TA0, T5, and PrefixSpanCoverage — with no canonical-slot precondition.
