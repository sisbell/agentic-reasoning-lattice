...
unit-depth discipline settles this for an output of *any* arity, with no appeal to triple
structure: every retraction to-set in `Σ'.L` is unit-depth at some link `t ∈ dom(Σ'.L)`,
