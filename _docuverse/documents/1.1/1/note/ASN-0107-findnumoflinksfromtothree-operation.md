...
| R1 | No store-level link retraction exists; under (P-last)/(P-slot)/(P-sole), minimal contraction gives `Δnum_disc ∈ {−1,0}` (the `k=1` case of R2) | introduced |
