...
P4★ bounds provenance by the *content-subspace* restriction of containment (scoped to the content subspace so it coexists with P7). P4★ is a Class (b) composite-boundary property: K.μ⁺ alone may transiently violate it (it adds to Contains_C but does not extend R), with restoration at the composite boundary governed by J1★.
