...
*Notation.* Verification lines use extended-state labels (P4★, J1★, etc.); since the example's arrangement is content-subspace-only, each starred form reduces here to its four-component ancestor.
