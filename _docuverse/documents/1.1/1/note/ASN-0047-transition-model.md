...
**ValidComposite★ (forward pointer).** Several statements below appeal to the validity of a composite transition before its full definition is reached. Validity is defined by ValidComposite★, stated in full in *Scoped coupling constraints* below; its two clauses are (1) per-step elementary preconditions evaluated at intermediate states and (2) the couplings J0, J1★, J1'★ evaluated between the composite endpoints Σ and Σ'. Every reference to "ValidComposite★" or "valid composite" below uses that definition.
...
Validity of a composite transition `Σ →* Σ'` is ValidComposite★ (stated in full in *Scoped coupling constraints* below). P4★ is discharged at composite boundaries by clause (2)'s couplings.
