...
R6d (RetractionStabilityUnderConformingLayer, Three Operations) lifts R6a and R6c from `→`/`→*` to the `↝`-steps of a substrate-conforming layer.
