...
*Scope.* The witnessing tuple `(b, F', G')` ranges over the triple-restricted `L_R^Σ` (the `|Σ.L(a)| = 3` conjunct of *Definition — TypedRelation*), so only standard-triple links can retract (StandardTriple, ASN-0043; Convention RetractionDirectionality).
