...
- *Depends:* T4 (HierarchicalParsing, ASN-0034) — field correspondence; T4b (UniqueParse, ASN-0034) — projection definitions.
...
- *Depends:* S7b (element-level I-addresses) — provides `E(a)`; T4b (UniqueParse, ASN-0034) — defines element-field projection; TA7a (ASN-0034) — `⊕` and `⊖` on the within-subspace ordinal require operands in `S`, i.e. non-empty (`#o ≥ 1`) with positive components, which `#E(a) ≥ 2` together with componentwise positivity supplies.
