...
*Proof.* S8a is a design requirement: V-positions are element-field tumblers of depth at least 2, paralleling S7c for I-address element fields. A V-position is an isolated element field; the conjuncts follow from this element-field commitment together with T0's ℕ-valued carrier. We show each conjunct follows from this structural commitment.
