...
In every admissible sub-case, k₁ = k₂. Hence a₁ + k₁ = M(d)(w) = a₂ + k₁. When k₁ = 0: a₁ = a₂ directly. When k₁ ≥ 1: shift(a₁, k₁) = shift(a₂, k₁) with #a₁ = #a₂ (from equal result lengths), so TS2 gives a₁ = a₂.
