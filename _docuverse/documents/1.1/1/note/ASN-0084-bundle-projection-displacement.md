...
**Canonical decomposition.** The *canonical run decomposition* of an arrangement is the partition of its V-positions into *maximal* runs — runs that cannot be extended by merging with a V-adjacent, I-adjacent neighbor. Its existence and uniqueness for the post-state M'(d) are the post-state S8 discharge recorded in the Invariant-preservation audit above.
