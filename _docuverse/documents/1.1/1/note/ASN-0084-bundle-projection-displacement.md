...
We write w_α = |α|, w_β = |β|, w_μ = |μ| for the region widths. Their identification with cut-ordinal differences and their positivity are established in the *Width positivity* consequence of R-PRE below.
