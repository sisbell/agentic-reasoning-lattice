...
This completes R-BLK: B' is a valid run partition of M'(d). B′ may contain mergeable adjacent pairs even when the pre-state partition B had none, since the rearrangement can bring runs of common origin into V- and I-adjacency; B′ is therefore not necessarily maximal (see R-CANON).
