...
Identity clause
  ...
  []  ω(d_src) ≠ π  →  branch requires zeros(pfx(π)) = 1 — π already holds a
                        ...
                        Document(v), v ∉ E, pfx(π) ≼ v (O5(i)), and — proved
                        ...
                        Which sibling of S(pfx(π), 2) v is — the frontier detail —
                        stays out of scope; the maximality V9 consumes does not
                        depend on it                            (fork across ownership)
  fi
