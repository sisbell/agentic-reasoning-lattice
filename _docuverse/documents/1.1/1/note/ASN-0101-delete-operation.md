...
*DEL-neutrality fact.* The boundary derivation below relies on one fact about how a single DEL step moves the composite-boundary property P4a; we establish it here and cite it by name (N2) in the induction.
