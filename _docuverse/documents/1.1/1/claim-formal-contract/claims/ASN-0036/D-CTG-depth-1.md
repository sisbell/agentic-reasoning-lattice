# Claim Formal Contract — ASN-0036/D-CTG-depth — run 1

*2026-06-25T19:21:41Z*
*Model: opus*
*Cycles: 1*
*Validation: MISMATCH*
...
- `MISSING_PRECONDITION: T1(i) (lexicographic position ordering — at the first component of disagreement between two same-depth positions, the one with the smaller component value is the smaller position, ASN-0034) — invoked twice in the proof to establish u < w and w < x, but absent from the contract despite T0(a) being listed on the same grounds`
- `MISSING_PRECONDITION: T3 (CanonicalRepresentation, ASN-0034 — two tumblers are equal iff every component is equal) — invoked to conclude that the infinitely many distinct values of n produce infinitely many distinct positions w, establishing the contradiction with S8-fin; absent from the contract despite T0(a) being listed on the same grounds`
