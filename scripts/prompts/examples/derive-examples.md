...
Read the formal statements. Find the properties and their *Formal Contract:* fields. For each one, ask: what is the smallest concrete state where this property does real work? The preconditions define the valid inputs. The postconditions define what to check. Construct it, apply the operation, state the expected result. Move on.
...
- [What the property needs and why it isn't covered yet]
```
...
The formal statements follow below. Each property has a *Formal Contract:*
