...
Read the ASN. Find the properties. For each one, ask: what is the smallest concrete state where this property does real work? Construct it, apply the operation, state the expected result. Move on.
