...
from lib.claim_convergence.core.topological_sort import topological_sort_labels

REPAIR_TEMPLATE = prompt_path("claim-convergence/converge/extract-proof.md")
