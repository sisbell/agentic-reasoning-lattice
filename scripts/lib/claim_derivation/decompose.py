...
to lib/agents/producers/claim_decompose/agent.py::ClaimDecomposeAgent.
The agent owns the actual work (mechanical split, parallel LLM
analysis, body resolution, claim md write, identity emissions to
substrate, commit).
