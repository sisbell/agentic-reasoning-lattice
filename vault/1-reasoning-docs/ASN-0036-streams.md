...
*Formal Contract:*
- *Preconditions:* V_S(d) non-empty; common V-position depth m ≥ 2 (S8-depth); D-CTG (VContiguity); D-CTG-depth (SharedPrefixReduction, for m ≥ 3); D-MIN (VMinimumPosition); dom(M(d)) finite (S8-fin).
