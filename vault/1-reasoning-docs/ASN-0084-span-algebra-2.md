...
*a₁ = a₂:* With v₁ = v₂, w = v₁ + k₁ = v₁ + k₂ gives k₁ = k₂ (by TS2 when both ≥ 1; when one is 0, TS4 forces the other to be 0). Hence a₁ + k₁ = M(d)(w) = a₂ + k₁. When k₁ = 0: a₁ = a₂ directly. When k₁ ≥ 1: shift(a₁, k₁) = shift(a₂, k₁) with #a₁ = #a₂ (from equal result lengths), so TS2 gives a₁ = a₂.
