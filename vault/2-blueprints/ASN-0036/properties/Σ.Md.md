...
*Formal Contract:*
- *Definition:* `Σ.C : T ⇀ Val` — the content store is a partial function from tumblers to content values.
...
*Formal Contract:*
- *Definition:* `Σ.M(d) : T ⇀ T` — the arrangement of document `d` is a partial function from V-position tumblers to I-address tumblers.
