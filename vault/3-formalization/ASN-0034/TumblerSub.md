...
- *Postconditions:* a ⊖ w ∈ T, #(a ⊖ w) = max(#a, #w); when zpd(a, w) is defined: Pos(a ⊖ w) (PositiveTumbler), actionPoint(a ⊖ w) = zpd(a, w) (ActionPoint)
