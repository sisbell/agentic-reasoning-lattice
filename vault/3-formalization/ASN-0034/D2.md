...
For w: the hypothesis states a ⊕ w = b, so the addition is well-defined. TA0 requires Pos(w) (satisfied since the addition produces a result) and actionPoint(w) ≤ #a.
