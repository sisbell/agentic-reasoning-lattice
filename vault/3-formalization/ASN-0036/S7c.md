...
With S7a and S7b established, we can state structural attribution. (S7c, stated here for architectural completeness, is load-bearing for S8-crun's ordinal shift analysis below, not for S7 itself.)
