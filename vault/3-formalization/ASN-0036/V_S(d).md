...
- *Preconditions:* S8a (V-position well-formedness) — every v ∈ dom(Σ.M(d)) satisfies zeros(v) = 0 ∧ v₁ ≥ 1 ∧ v > 0; S8-depth (MinimalVPositionDepth) — within any subspace, all V-positions share a common depth.
