...
*Formal Contract:*
- *Preconditions:* `a₁, a₂ ∈ dom(Σ.C)` produced by distinct allocation events within a system conforming to T10a (allocator discipline, ASN-0034), GlobalUniqueness (ASN-0034), and T3 (CanonicalRepresentation, ASN-0034).
