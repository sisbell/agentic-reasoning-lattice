...
impl M3State {
    ...
    /// so a Some answer never regresses) — or if the namespace gate trips. The returned prefix still
...
```rust
pub fn apply_ns(&self, r: &M3Rec) -> M3State {     // pub — the engine crate wires World::apply to this
