...
where W: WorldState + HasLinks + HasM3, W::Record: From<LinkRec> + From<M3Rec>
{
    ...
    /// [K_sup]-writers, the parallel of the [R] fence; Conflicts §10). Shape-gated (registered ∧
...
impl LinkState {
    ...
    pub fn is_filtered(&self, a: &Address) -> bool;                       // v1: single shipped BH1 (Retired) — build-enforced (§B); see §7
