...
assert DisplacementRoundTrip {
  all disj a, b, w, result: Tumbler |
    (tumblerLT[a, b] and divergence[a, b] =< a.len and a.len =< b.len
     and TumblerSub[b, a, w] and TumblerAdd[a, w, result])
    implies tumblerEq[result, b]
}

-- Non-vacuity
run NonVacuity {
  some disj a, b, w, result: Tumbler |
    tumblerLT[a, b] and divergence[a, b] =< a.len and a.len =< b.len
    and TumblerSub[b, a, w] and TumblerAdd[a, w, result]
} for 5 but exactly 4 Tumbler, 5 Int

check DisplacementRoundTrip for 5 but exactly 4 Tumbler, 5 Int
