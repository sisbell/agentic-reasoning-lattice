...
Same-depth tightness — established in CL0's proof by the I-address discreteness argument — means each CL0 I-span captures every I-address in the image at depth `#a_β`, with no spurious same-depth addresses.
...
| ExtendedReachableStateInvariants | Every reachable state satisfies S0 ∧ S1 ∧ S2 ∧ S3★ ∧ S3★-aux ∧ S8a ∧ S8-fin ∧ S8-depth ∧ S8 ∧ D-CTG ∧ D-MIN ∧ P0–P2 ∧ P3★ ∧ P4★ ∧ P5★ ∧ P6–P8 ∧ L0 ∧ L1 ∧ L1a ∧ L12 ∧ L14 ∧ CL-OWN; supersedes ASN-0047 ReachableStateInvariants | introduced |
