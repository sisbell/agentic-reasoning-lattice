...
- Explicit invocation: `python scripts/run-trigger.py cone_review <asn> --claim <apex>`.
- Bulk sweep: `python scripts/run-trigger.py cone_review <asn>` walks all qualifying apexes.
