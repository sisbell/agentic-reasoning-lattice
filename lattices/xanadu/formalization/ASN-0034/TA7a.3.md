...
As a sentinel (TA6), `r` is not a valid address and serves as a lower bound relative to every positive tumbler; its appearance as the self-subtraction residue marks the "no-displacement" fixed point of `⊖`. ∎
...
- *Depends:*
  ...
  - TA6 (ZeroTumblers) — sentinel interpretation of the residue.
