...
- *Depends:*
  ...
  - T4 (HierarchicalParsing) — anchors the element-field shape underlying **S**: each subspace corresponds to a well-parsed hierarchy position whose ordinal lives in **S**.
  ...
  - TA6 (ZeroTumblers) — supplies the sentinel interpretation of `[0, ..., 0]` underlying **Z** and is cited by sub-claim TA7a.3 which characterises the self-subtraction residue.
