...
- *Depends:*
  ...
  - T1 (LexicographicOrder) — derives aₖ < bₖ from a < b at divergence point k; discharges TumblerSub's precondition b ≥ a from a < b via the ≤ abbreviation (a ≤ b ≡ a < b ∨ a = b) and the ≥ abbreviation (b ≥ a ≡ a ≤ b).
