...
**MAT-0002, §"Temperature as a functional of mean translational vis viva"**: "In the equilibrium regime, in the dilute regime, and under the centres-of-force modeling of encounters, the temperature of a body is a strictly monotone function of B.T̄ alone..."
...
**MAT-0002, §"Conservation through encounters"**: "**[P.enc_ratio_equilibration]** In the equilibrium regime the mean ratio of internal to translational vis viva per molecule of a species is (β − 1), maintained as a steady state."
