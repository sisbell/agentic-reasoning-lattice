...
**MAT-0002, "Conservation through encounters"**: "(iv) the inter-molecular force is conservative — central, depending only on the separation of the pair, and derivable from a scalar potential U(r) that vanishes outside the sphere of sensible action."
...
**MAT-0002, "The primacy of motion"**: "a statical theory in which elastic response arises from inter-particle forces at rest predicts a fixed ratio between the elasticity of form and the elasticity of volume of any body. That ratio is wrong in two distinct domains. In fluids, form-elasticity is vanishing while volume-elasticity is considerable... In solids, direct measurement of form-elasticity comes in smaller than the statical ratio predicts."
