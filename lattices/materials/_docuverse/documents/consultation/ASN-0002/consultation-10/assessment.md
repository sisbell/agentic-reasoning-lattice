# Channel Assignment — ASN-0002 review-10

**Date:** 2026-05-05 08:13
...
Theory question: For species with internal degrees of freedom (β > 1), does Maxwell's 1867 theory present the conservative-central-COM-force characterization of encounters as a complete description (restricted to β = 1 species), as the COM-COM component of a more general encounter force whose internal-coupling part is left unmodelled, or as scoped by some other regime qualifier — and how does the theory locate the apportionment postulate (following Clausius) relative to that characterization?
