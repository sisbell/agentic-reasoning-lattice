...
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — the review machinery where voice discipline operates. The Dijkstra voice is carried in both the reviewer prompt (how to read) and the reviser prompt (how to write).