...
The [maturation protocol](../protocols/maturation/note-to-claim.md) governs review/revise cycles on notes during discovery. The 90/10 ratio is a quality boundary within that protocol — monitored but not enforced by the convergence predicate itself.
...
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — the protocol whose review cycles this principle's signals monitor.
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — the protocol governing note-level review where the 90/10 ratio applies.
