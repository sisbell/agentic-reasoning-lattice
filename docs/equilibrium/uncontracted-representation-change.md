...
- [Claim Derivation Module](../protocols/maturation/note-to-claim.md) — the protocol whose structural contract (B5) is the first instance of this resolution.