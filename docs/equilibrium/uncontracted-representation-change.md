...
- [Claim Derivation Module](../protocols/claim-derivation-module.md) — the protocol whose structural contract (B5) is the first instance of this resolution.