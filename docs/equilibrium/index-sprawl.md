...
- [The Coupling Principle](../principles/coupling.md) — index sprawl is a coupling violation: surface grows without advancing reasoning in either direction. The coupling principle's feedback loop shows how this detection drives claim-refinement prompt calibration.
