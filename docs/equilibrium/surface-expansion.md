...
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — the full-review scale at which cumulative surface expansion becomes detectable across multiple claims at once. The REVISE/OBSERVE classification operates within the protocol's review prompts.