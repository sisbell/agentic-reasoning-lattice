...
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — oscillation is a pathology of the review/revise loop. The protocol's wider scales (regional, full) can see oscillations that local-scale review cannot, because they see cross-cycle diff history. The REVISE/OBSERVE classification within the protocol prevents most judgment-call oscillation from starting.
