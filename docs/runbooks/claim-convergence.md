...
Mechanical — reads YAML summaries + .md contracts, writes `claim-statements.md` and `dependency-graph.yaml` to `lattices/xanadu/manifests/`.
...
See the [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) for the predicate contract and stage-1 architecture.
