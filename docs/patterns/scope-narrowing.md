...
[Dependency cone](dependency-cone.md) — the signal that narrowing has overshot. One claim thrashing against stable dependencies means the scope is too narrow for the coupling.
