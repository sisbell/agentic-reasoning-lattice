...
- Claim derivation narrows into claims → the [claim convergence protocol](../protocols/maturation/note-to-claim.md) reviews at progressively wider scope, with comprehensive-scope review verifying the whole note
