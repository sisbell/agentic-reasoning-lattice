...
- Blueprinting narrows into claims → the [claim convergence protocol](../protocols/claim-convergence-protocol.md) reviews at progressively wider scope, with comprehensive-scope review verifying the whole note
