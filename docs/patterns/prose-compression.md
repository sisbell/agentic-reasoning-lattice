...
**Claim-refinement-stage compression.** Compression also happens during claim refinement's own review cycles, often accompanied by extracting the concept into its own claim. Three cases from ASN-0036 cone-scoped review:
