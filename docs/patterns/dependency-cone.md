...
[Claim Convergence Protocol](../protocols/claim-convergence-protocol.md) — the multi-scale architecture that emerged from the cone problem. Local, regional, and full scales composed into an upward-downward pass, each handling the error class it is efficient at.
