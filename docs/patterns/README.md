...
- **Ground State** — claim-convergence across all scales (claim, cluster, system review all agree). Defined in [glossary](../glossary.md#g); discussed in [Claim Convergence Protocol](../protocols/maturation/note-to-claim.md). Not yet a standalone pattern doc.
