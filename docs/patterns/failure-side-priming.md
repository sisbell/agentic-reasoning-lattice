...
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — defines the comment/resolution/rejection machinery whose rejection state this pattern reads.
