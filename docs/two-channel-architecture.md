...
- [Maturation Stigmergic Protocol](protocols/maturation/note-to-claim.md) — the protocol that drives the synthesized note toward stability after channels produce it.
