...
- [Verification V-Cycle](verification-v-cycle.md) — multi-scale review architecture. Local, regional, and global review cycles each handle the error class they're efficient at, with upward-then-downward passes through the scales.
