...
This note is about how the second layer behaves across notes.
...
- [Maturation Stigmergic Protocol](../protocols/maturation/note-to-claim.md) — the review/revise cycles that drive the second and third narrowing stages
