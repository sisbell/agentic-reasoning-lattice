...
- [Claim Convergence Protocol](../protocols/maturation/note-to-claim.md) — the review machinery that this rule governs at every scale (local-review, regional-sweep, full-review).
