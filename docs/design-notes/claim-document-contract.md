...
Scope: this contract governs the per-claim outputs produced by the [maturation protocol](../protocols/maturation/note-to-claim.md). For each claim the protocol produces:
