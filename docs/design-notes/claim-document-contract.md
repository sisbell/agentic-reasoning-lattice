...
Scope: this contract governs the per-claim outputs produced by the [claim derivation module](../protocols/maturation/note-to-claim.md). For each claim the protocol produces:
...
- [Claim Derivation Module](../protocols/maturation/note-to-claim.md) — the protocol whose output this contract governs.
